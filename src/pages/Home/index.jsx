              ...
              <td> R$
            {
              ...
              <td>
                <div className="Buttons">
                  <button className="EditEmployee" onClick={() => handleEditEmployee(employee.id)}>Editar</button>
                  <button className="RemoveEmployee" onClick={() => handleRemoveEmployee(employee)}>Remover</button>
                </div>
              </td>
            </tr>
          ))}
